...
class LoadImages:
    ...
    def __next__(self):
        ...
        # Padded resize
        # LOGGER.info(f"Image before letterbox - {img0.shape} {img0}")
        img = letterbox(img0, self.img_size, stride=self.stride, auto=self.auto)[0] # take im only
        # LOGGER.info(f"Image after letterbox - {img.shape} {img}")
        # cv2.imshow(img)
